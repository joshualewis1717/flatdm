...
export default function ProfileButton({ role, username, profileUrl,href }: props) {
    return (
      <Link className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white/[0.04] border 
